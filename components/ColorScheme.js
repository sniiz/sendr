// source: https://github.com/c0bra/color-scheme-js 🙌
...
(function () {
    ...
    ColorScheme = (function () {
        ...
        ref = "mono monochromatic contrast triade tetrade analogic".split(
            /\s+/
        );
        ...
        ColorScheme.prototype.from_hex = function (hex) {
            ...
            if (!/^([0-9A-F]{2}){3}$/im.test(hex)) {
                throw (
                    "from_hex(" +
                    hex +
                    ") - argument must be in the form of RRGGBB"
                );
            }
