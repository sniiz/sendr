// source: https://gist.github.com/vishnevskiy/f4ba74adf5cf1d269b860fab86e8feef
// TODO use this instead of flatlist
    ...
    compute(
        ...
        for (let section = 0; section < sections.length; section++) {
            ...
            if (
                ...
                const spacerLayoutHeight = items.reduce(
                    (totalHeight, item, i) => {
                        if (i !== items.length - 1) {
