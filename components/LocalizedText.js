...
const uiText = {
  en: {
    ...
    secretSettingsScreen: {
      barTitle: "dev settings",
      intro: "you hear a hidden door slowly slide open...",
    },
    profileScreen: {
      barTitle: "profile",
      wipText:
  ...
  fr: {
    ...
    secretSettingsScreen: {
      barTitle: "paramètres secrets",
      intro: "tu entends une porte cachée qui s'ouvre lentement...",
    },
    profileScreen: {
      barTitle: "profil",
      wipText:
  ...
  es: {
    ...
    secretSettingsScreen: {
      barTitle: "ajustes secretos",
      intro: "oyes cómo se abre lentamente una puerta oculta...",
    },
    profileScreen: {
      barTitle: "perfil",
      wipText:
  ...
  ru: {
    ...
    secretSettingsScreen: {
      barTitle: "секретные настройки",
      intro: "ты слышишь, как за тобой открывается секретный проход...",
    },
    profileScreen: {
      barTitle: "профиль",
      wipText:
